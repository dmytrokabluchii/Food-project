...
function calc() {
  ...
  let sex, height, weight, age, ratio; // Установим в localStorage введенные польз-м значения и значения по дефолту
  ...
  } // При заходе на стр-цу очищать класс активности у кнопок и когда совпадет по значению,
  // то на кнопку навешивать класс активности
  ...
  initLocalSettings('.calculating__choose_big div', 'calculating__choose-item_active'); // Фун-я общего вычисления калорий, вызыв-я каждый раз когда на стр-це проис-т измен-е
  ...
  calcTotal(); // Фун-я получ-я статических данных по калориям и перекл-ю активности
  ...
  getStaticInformation('.calculating__choose_big div', 'calculating__choose-item_active'); // Фун-я обраб-я каждый отдел-й input
...
function cards() {
  class MenuCard {
    constructor(src, alt, title, description, price, parentSelector) {
      ...
      this.parent = document.querySelector(parentSelector); // сюда запишем статич-й курс валют(в будущем можно поменять если курс будет прих-ть от сервера)

      this.transfer = 27;
      this.changeToUAN();
    } // метод заним-я конвер-й валюты
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postDada)('http://localhost:3000/requests', json).then(data => {
...
function burgerMenu(_ref) {
  ...
  burgerButton.addEventListener('click', function () {
    ...
    document.body.classList.toggle('open'); // добав-м стиль не позвол-й прокручивать стр-цу
...
function openModal(modalSelector, modalTimerId) {
  ...
  document.body.style.overflow = 'hidden'; // если у нас есть modalTimerId то запустим очистку таймера
...
function slider(_ref) {
  ...
  let slideIndex = 1;
  let offset = 0; // Отображаем или нет 0 в общем счетчике слайдов
  ...
  slidesField.style.display = 'flex'; // Добавим плавности блоку при перек-и слайдов и далее скроем неиспол-е слайды

  slidesField.style.transition = '0.5s all';
  slidesWrapper.style.overflow = 'hidden'; // Переб-м все слайды на стр-це, где внутри нах-ся каждый отдел-й слайд (slide)
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  const tabs = document.querySelectorAll(tabsSelector),
        ...
        tabsParent = document.querySelector(tabsParentSelector); // делаем фун-ю(она может быть универсальной) где скрываем все ненуж-е нам табы!
  ...
  hideTabContent();
  showtabContent(); // испол-я делегирование, созд-м событие на клик
...
/* harmony export */   "postDada": function() { return /* binding */ postDada; }
/* harmony export */ });
